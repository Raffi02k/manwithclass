...
function PageMeta() { const { pathname } = (0, react_router_dom_1.useLocation)(); (0, react_1.useEffect)(() => { const meta = (0, seo_1.getMetadata)(pathname); document.documentElement.lang = meta.lang; const template = document.createElement('template'); template.innerHTML = (0, seo_1.renderHead)(pathname); document.head.querySelectorAll('title,meta[name="description"],meta[name="robots"],meta[name="twitter:card"],meta[property^="og:"],link[rel="canonical"],link[rel="alternate"][hreflang],#structured-data').forEach(el => el.remove()); document.head.append(...Array.from(template.content.childNodes)); }, [pathname]); return null; }
