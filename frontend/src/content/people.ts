...
export interface Person {
  ...
  presentation: { sv: string; en: string };
  specialties: { sv: string[]; en: string[] };
  timeline: TimelineItem[];
  storyEyebrow: string;
  storyTitle: { sv: string[]; en: string[] };
  storySignoff: { sv: string; en: string };
  galleryIds: string[];
  galleryNote: { sv: string; en: string };
  instagram?: string;
  contactLabel?: { sv: string; en: string };
  contactNote: { sv: string; en: string };
}
...
export const people: Person[] = [
  {
    ...
    specialties: {
      sv: ['Stil & skrädderi', 'Kollektioner', 'Personlig stil'],
      en: ['Style & tailoring', 'Collections', 'Personal style']
    },
    timeline: [
      {
        label: { sv: '2018', en: '2018' },
        text: { sv: 'De första visionerna och grunden för ett skräddarsytt modeuttryck tar form i Stockholm.', en: 'The first ideas and the foundations of a tailored approach to style take shape in Stockholm.' }
      },
      {
        label: { sv: '2020–2022', en: '2020–2022' },
        text: { sv: 'Konceptet med extremt limiterade kollektioner etableras, ofta endast 15 exemplar per plagg. En kundkrets växer fram som uppskattar quiet luxury och genuint hantverk.', en: 'The concept of highly limited collections takes shape, often with just 15 pieces per garment. A following develops around quiet luxury and genuine craftsmanship.' }
      },
      {
        label: { sv: 'Nästa kapitel', en: 'The next chapter' },
        text: { sv: 'Wan de Roy tar nästa steg genom samarbeten med MenWith-nätverket. Behind the brand i Stockholm och på den internationella modescenen.', en: 'Wan de Roy takes the next step through collaborations with the MenWith network. Behind the brand in Stockholm and on the international fashion scene.' }
      }
    ],
  ...
  },
  {
    ...
    timeline: [
      {
        label: { sv: 'Välj behandling', en: 'Choose your treatment' },
        text: { sv: 'Utforska salongens behandlingsmeny och välj det du vill boka.', en: 'Explore the salon treatment menu and choose what you would like to book.' }
      },
      {
        label: { sv: 'Boka med Serhi', en: 'Book with Serhi' },
        text: { sv: 'Välj Serhi som utförare i Bokadirekt och hitta en ledig tid som passar dig.', en: 'Select Serhi as your barber on Bokadirekt and find an available time that suits you.' }
      },
      {
        label: { sv: 'Välkommen till Odenplan', en: 'Welcome to Odenplan' },
        text: { sv: 'Du hittar Man With Class på Upplandsgatan 51 i Vasastan, Stockholm.', en: 'Find Man With Class at Upplandsgatan 51 in Vasastan, Stockholm.' }
      }
    ],
...
export const publishedPeople: Person[] = people.filter(person => person.published);
